package com.poliban.ac.id.e020320093.homework73;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "com.poliban.ac.id.e020320093.homework73.RANDOM_NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PowerReceiver HomeWork");
